...
const platformRollbit = "/assets/platforms/rollbit.png";
const platformShuffle = "/assets/platforms/shuffle.png";
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <span className="text-sm font-medium">
          ...
          <Link href="/switch" className="text-primary hover:underline">
            Check Eligibility
          </Link>
        </span>
      </div>
    ...
    >
      ...
      <div className="relative z-10 p-6 flex flex-col sm:flex-row items-start sm:items-center gap-6">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <Link href="/arena" className="text-[10px] text-muted-foreground hover:text-foreground transition-colors">
            View Stats
          </Link>
        </div>
      </div>
