...
import { Zap, TrendingUp, Clock, Check, X } from "lucide-react";
...
const openWagers: Wager[] = [
  { id: "1", event: "BTC above $100k by March?", options: ["Yes", "No"], odds: [1.8, 2.1], payout: 0, status: "open" },
  { id: "2", event: "ETH flips SOL in 24h volume?", options: ["Yes", "No"], odds: [3.2, 1.3], payout: 0, status: "open" },
  { id: "3", event: "Crash game > 100x today?", options: ["Yes", "No"], odds: [5.0, 1.1], payout: 0, status: "open" },
];
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] text-muted-foreground flex items-center gap-1 mt-0.5">
                    <Clock className="w-3 h-3" /> Closes in 6h
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-2">
          {pastWagers.map((w, i) => (
            ...
            >
              <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${
                w.status === "won" ? "bg-primary/20" : "bg-destructive/20"
              }`}>
                {w.status === "won" ? (
              ...
              <span className={`text-sm font-display font-bold ${
                w.status === "won" ? "text-primary" : "text-destructive"
              }`}>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-muted-foreground">
              Record: <span className="text-primary font-semibold">2W</span> - <span className="text-destructive font-semibold">1L</span>
            </p>
          </div>
        </div>
      )}
